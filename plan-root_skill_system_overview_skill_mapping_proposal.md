...
| --- | --- | --- |
| `l0-001-skill-invoke` | やや大きい | read set、authority 判定、opportunity loop が混在 |
| `l1-001-skill-plan` | 大きい | plan、phase、close、current 収束まで抱えやすい |

### IntakeHelpers

| skill | 評価 | コメント |
| --- | --- | --- |
| `l1-006-rule-snapshot-read` | 妥当 | 維持でよい |
| `l1-007-authoritative-doc-scope-resolve` | 妥当 | 維持でよい |
| `l1-008-rule-diff-clarify` | 妥当 | 維持でよい |
| `l1-009-write-boundary-guard` | 妥当 | 維持でよい |

### PlannerHelpers

| skill | 評価 | コメント |
| --- | --- | --- |
| `l1-003-task-intent-normalize` | 妥当 | 維持でよい |
| `l1-004-task-scope-split` | 妥当 | 維持でよい |
| `l1-005-close-condition-define` | 妥当 | 維持でよい |
| `l1-002-phase-task-orchestrate` | 妥当 | 維持でよい |

### DocFlow

| skill | 評価 | コメント |
| --- | --- | --- |
| `l2a-005-documentation-watchkeep` | 抽象度が高い | 何を監視するかを分けたい |
| `l2b-001-doc-target-resolve` | 妥当 | 維持候補 |
| `l2b-002-script-doc-sync-enforce` | 一部不足 | runbook pair 同期までは足りない |
| `l2a-009-test-evidence-record` | やや大きい | test と evidence は分けられる |
| `l2b-008-evidence-destination-resolve` | 妥当 | 維持候補 |
| `l2b-009-log-promotable-facts-extract` | 妥当 | 維持候補 |

### DesignFlow

| skill | 評価 | コメント |
| --- | --- | --- |
| `l2a-001-design-first-script-build` | 妥当 | 維持候補 |
| `l2a-002-reference-rewire-operate` | 妥当 | 維持候補 |
| `l2b-003-path-contract-scan` | 不足 | scan はできても steward 不足 |
| `l2b-004-artifact-handoff-map` | 不足 | mapping 後の authoritative 維持 skill が必要 |

### RuntimeFlow

| skill | 評価 | コメント |
| --- | --- | --- |
| `l2a-004-runtime-operate` | 妥当 | 維持候補 |
| `l2b-005-runtime-structure-dependency-map` | 妥当 | 維持候補 |
| `l2b-007-runtime-bootstrap-scope-resolve` | 妥当 | 維持候補 |
| `l2b-006-drive-input-bootstrap-check` | 妥当 | 維持候補 |
| `l2a-008-external-compute-output-keep` | やや広い | runbook pair / evidence / output custody と近接 |

### PlanningFlow

| skill | 評価 | コメント |
| --- | --- | --- |
| `l2a-003-delivery-plan-keep` | 大きすぎる | current / next action / MRL / BDD / TDD を抱えやすい |
| `l2a-007-frontier-research-curate` | 妥当 | 維持候補 |

### HiddenLoop

| skill | 評価 | コメント |
| --- | --- | --- |
| `lt-002-skill-opportunity-scout` | 妥当 | 維持 |
| `lt-003-skill-opportunity-ledger` | 妥当 | 維持 |
| `lt-004-skill-opportunity-architect` | 妥当 | 維持 |
| `lt-005-skill-opportunity-integrate` | 妥当 | 維持 |
...
| --- | --- | --- | --- |
| `document-control-manager` | `l2a-005-documentation-watchkeep` など | truth / current / history を抱えすぎ | truth / current / history を分離 |
| `plan-gate-manager` | `l2a-003-delivery-plan-keep` | gate と ledger が大きすぎる | `mrl-ledger-maintainer` と `bdd-tdd-ledger-maintainer` を分離 |
