# l2b-007-runtime-bootstrap-scope-resolve capability test result
...
| --- | --- | --- | --- |
| t1 | frontmatter name が directory 名と一致する | `pass` | name='l2b-007-runtime-bootstrap-scope-resolve' |
