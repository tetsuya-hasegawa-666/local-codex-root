# l2b-010-skill-function-test-run capability test result
...
| --- | --- | --- | --- |
| t1 | frontmatter name が directory 名と一致する | `pass` | name='l2b-010-skill-function-test-run' |
...
| t8 | invoke と planner に登録されている | `pass` | expected integration exists |
