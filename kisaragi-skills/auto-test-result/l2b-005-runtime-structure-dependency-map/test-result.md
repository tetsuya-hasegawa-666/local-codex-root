# l2b-005-runtime-structure-dependency-map capability test result
...
| --- | --- | --- | --- |
| t1 | frontmatter name が directory 名と一致する | `pass` | name='l2b-005-runtime-structure-dependency-map' |
