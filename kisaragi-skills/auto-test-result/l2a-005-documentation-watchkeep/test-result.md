# l2a-005-documentation-watchkeep capability test result
...
| --- | --- | --- | --- |
| t1 | frontmatter name が directory 名と一致する | `pass` | name='l2a-005-documentation-watchkeep' |
...
| t8 | 文体 governance reference を持つ | `pass` | expected integration exists |
