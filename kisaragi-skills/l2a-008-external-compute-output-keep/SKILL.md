---
name: l2a-008-external-compute-output-keep
...
- `l0-001-skill-invoke` と `l1-001-skill-plan` が、`Colab`、remote notebook、remote GPU job などの外部 runtime task だと判断した時だけ呼ばれる。
