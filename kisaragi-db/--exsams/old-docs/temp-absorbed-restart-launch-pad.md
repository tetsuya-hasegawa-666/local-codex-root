...
- 恒久 truth は [project-truth-core.md](C:\Users\tetsuya\kisaragi\test\kisaragi-db\--devs\--tgpce-map\prj-kisaragi_0002\project-truth-core.md)
- plan / current / gate は [realtime-compass-and-status.md](C:\Users\tetsuya\kisaragi\test\kisaragi-db\--devs\--tgpce-map\prj-kisaragi_0002\realtime-compass-and-status.md)
...
- `MRL-10` の script 編集時の参照契約は [realtime-compass-and-status.md](C:\Users\tetsuya\kisaragi\test\kisaragi-db\--devs\--tgpce-map\prj-kisaragi_0002\realtime-compass-and-status.md) の `Increpose Path Handoff Matrix` を正とし、再検査は [da3_increpose_path_contract_probe.py](C:\Users\tetsuya\kisaragi\kisaragi-db\--devs\--testcode\prj-kisaragi_0002\da3_increpose_path_contract_probe.py) と関連 unittest を使う
- notebook cell、error、admin 実行結果の往復 log は [collaborative-worklog_da3-colab.md](C:\Users\tetsuya\kisaragi\test\kisaragi-db\--devs\--tgpce-map\prj-kisaragi_0002\collaborative-worklog_da3-colab.md)
- admin UX 手順は [admin-ux-method.md](C:\Users\tetsuya\kisaragi\test\kisaragi-db\--devs\--tgpce-map\prj-kisaragi_0002\admin-ux-method.md)
- admin evidence は [admin-ux-evidence.md](C:\Users\tetsuya\kisaragi\test\kisaragi-db\--devs\--tgpce-map\prj-kisaragi_0002\admin-ux-evidence.md)
...
1. [collaborative-worklog_da3-colab.md](C:\Users\tetsuya\kisaragi\test\kisaragi-db\--devs\--tgpce-map\prj-kisaragi_0002\collaborative-worklog_da3-colab.md) の最下部を読んで、最新の `# codex v**` と `# admin` を確認する。
2. [realtime-compass-and-status.md](C:\Users\tetsuya\kisaragi\test\kisaragi-db\--devs\--tgpce-map\prj-kisaragi_0002\realtime-compass-and-status.md) で `MRL-2S` と後続 `MRL-**` の current_state を確認する。
