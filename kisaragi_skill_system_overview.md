# kisaragi skill system overview

## 目的

- `kisaragi-skills/` 配下の skill 体系を、主線、補助 skill、実行 specialist、hidden backloop、refresh target manager 群の関係で俯瞰できるようにする。
- `agents.md` と `kisaragi_skill_trigger_system_map.md` の読解を補助する一覧図として使う。
